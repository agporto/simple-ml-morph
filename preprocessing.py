...
ap.add_argument('-m','--method', type=str, default='INTER_LINEAR', help="(optional) interpolation method used to change image resolution. Possible values: 'INTER_NEAREST', 'INTER_AREA', 'INTER_LINEAR' (default), 'INTER_CUBIC', 'INTER_LANCZOS4'. See cv2.resize() for details", metavar='')
